...
urlpatterns = [
    ...
    path("comments/<int:post_id>/comment/<int:comment_id>/edit/", CommentUpdateView.as_view(), name="comment-update"),
    path("comments/<int:post_id>/comment/<int:comment_id/delete/", CommentDeleteView.as_view(), name="comment-delete"),
]
